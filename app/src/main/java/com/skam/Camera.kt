...
import com.skam.classifier.*
import com.skam.classifier.tensorflow.ImageClassifierFactory
import com.skam.utils.getCroppedBitmap
import com.skam.utils.getUriFromFilePath
...
class Camera : AppCompatActivity() {
    ...
    private fun getColorFromResult(result: String): Int {
        return if (result == getString(R.string.Acne)) {
            resources.getColor(R.color.clear)
        } else {
